...
[
    ...
    ["чтобы начать работу с системой", "необходимо", "с выбора изображения для печати на мониторе компьютера"],
    ...
    ["цвета", "использующиеся", "в Indigo: CMYK - Cyan (Голубой), Magenta (Пурпурный), Yellow (Желтый), Key (Черный)"],
    ["Just-In-Time","- это", "технология, позволяющая распечатать материал за 24 или 12 часов в зависимости от типа печати"],
    ["Операционная система у Indigo", "- это", "Indigo-OS"],
    ["ОС Indigo", "- это", "Indigo-OS"],
    ["Операционная система у Индиго", "- это", "Indigo-OS"],
    ["ОС Индиго", "- это", "Indigo-OS"]
]
